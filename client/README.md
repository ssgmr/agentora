...
# 3. 启动 Godot
D:/tool/Godot_v4.6.2-stable_win64.exe/Godot_v4.6.2-stable_win64.exe --path client
```
...
```bash
# 以编辑器模式启动（可调试）
D:/tool/Godot_v4.6.2-stable_win64.exe/Godot_v4.6.2-stable_win64.exe --path client --editor

# 查看详细日志
D:/tool/Godot_v4.6.2-stable_win64.exe/Godot_v4.6.2-stable_win64.exe --path . --verbose
```
