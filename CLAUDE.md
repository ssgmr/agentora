...
### 测试结构 (`tests/`)
- **单元测试**：`decision_tests`, `crdt_tests`, `json_parse_tests`, `strategy_tests`, `memory_tests`, `legacy_tests`, `agent_tests`, `responsibility_boundary_tests`, `tier2_action_tests`, `tier3_emergence_tests`, `prompt_feedback_tests`
